...
*/
print("I have $\(myAccountBalance) in my bank account.")
/*: question6
...
print("I now have $\(myAccountBalance) in my bank account")
/*: question7
...
*/
print("I'll get an error if i try to do this because it is established as a 'constant' or 'let' variable")
/*:
